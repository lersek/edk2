...
!endif
  ...
  gArmPlatformTokenSpaceGuid.PcdDefaultBootDescription|L"OpenEmbedded 13.12 LSK (Linaro Stable Kernel) from virtio-blk"
  gArmPlatformTokenSpaceGuid.PcdDefaultBootDevicePath|L"VenHw(C1E791A2-64CF-4B68-BDF1-1C31DABBDC84,0006131C00000000)/HD(1,MBR,0x00000000,0x3F,0x19FC0)/uImage"
  gArmPlatformTokenSpaceGuid.PcdDefaultBootArgument|"console=tty0 console=ttyAMA0,38400n8 root=/dev/vda2 rootwait ro"
  gArmPlatformTokenSpaceGuid.PcdDefaultBootType|2
  gArmPlatformTokenSpaceGuid.PcdFdtDevicePath|L"VenHw(C1E791A2-64CF-4B68-BDF1-1C31DABBDC84,0006131C00000000)/HD(1,MBR,0x00000000,0x3F,0x19FC0)/v2p-ca15-tc1.virtio.dtb"

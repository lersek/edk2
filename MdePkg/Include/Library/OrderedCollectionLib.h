...
/**
  Delete a entry from the collection, unlinking the associated user structure.
  ...
  @param[in]     Entry       The collection entry to delete from Collection.
                             ...
                             - OrderedCollectionFind(), for deleting a entry by
                               user structure key,
                             ...
                             - OrderedCollectionNext() /
                               OrderedCollectionPrev(), for deleting a entry
                               found during an iteration,

                             - OrderedCollectionInsert() with return value
                               RETURN_ALREADY_STARTED, for deleting a entry
...
/**
  A potentially slow function that asserts that the collection satisfies its
  internal defining properties, and that it orders user structures correctly.

  Read-only operation.

  This function might use the stack for recursion and is not recommended for
  "production use".

  @param[in] Collection  The collection to validate.
**/
VOID
EFIAPI
OrderedCollectionValidate (
  IN CONST ORDERED_COLLECTION *Collection
  );

  ...
  )
{
  ...
  if (!mXen) {
    ...
    if (mHostBridgeDevId == INTEL_Q35_MCH_DEVICE_ID) {
      ...
      //
      // The (exclusive) end of the MMCONFIG area should be expressible as a
      // UINT64. Additionally, the MMCONFIG area is expected to fall between
      // the top of low RAM and the base of the 32-bit PCI host aperture.
      //

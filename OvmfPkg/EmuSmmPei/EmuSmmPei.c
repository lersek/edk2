  ...
  )
{
  ...
  if (EmuNvramSmramSize () == 0 ||
      EmuNvramSmstPtrSize () != sizeof (EFI_PHYSICAL_ADDRESS)) {
    return EFI_UNSUPPORTED;
  }

  mResumeState.Smst = *(EFI_PHYSICAL_ADDRESS *)(UINTN) EmuNvramSmstPtrBase ();
